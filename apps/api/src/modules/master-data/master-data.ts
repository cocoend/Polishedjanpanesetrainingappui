...
export const explanationModels: ExplanationModelRecord[] = [
  {
    ...
    slug: 'prep',
    nameJa: 'PREP法',
    shortDescription: '结论优先，用理由和例子支撑观点。',
    longDescription: '先说结论，再补充理由和例子，最后回到结论，适合表达意见和主张。',
  ...
  },
  {
    ...
    longDescription: '按照时间顺序或步骤顺序来解释，适合介绍流程、做法和使用方法。',
  ...
  },
  {
    ...
    slug: 'scqa',
    nameJa: 'SCQA法',
    shortDescription: '从情境、问题到解法，适合逻辑说明。',
    longDescription: '先铺垫背景，再引出问题与疑问，最后提出答案，适合提案和问题解决。',
